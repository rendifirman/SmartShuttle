  ...
  <div class="flex flex-col min-h-screen md:flex-row">
    ...
    <div class="w-full md:w-1/2 flex items-start justify-center px-6 sm:px-8 md:px-12 lg:px-20 text-white relative right-overlay min-h-screen pt-16">
      ...
      <div class="flex flex-col items-center mb-6 md:mb-8 right-title-align">
        ...
        <div class="mt-5 md:mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-transparent text-white/80 text-xs md:text-sm">Atau masuk dengan</span>
            </div>
          </div>

          <div class="mt-5 md:mt-6">
            <a href="{{ route('login.google') }}"
               class="w-full flex justify-center items-center gap-2 md:gap-3 py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FF581E] transition-all duration-300 text-sm md:text-base">
        ...
        <!-- Link ke register -->
        <p class="mt-5 md:mt-6 text-white/80 text-center text-sm md:text-base">
          Belum punya akun?
