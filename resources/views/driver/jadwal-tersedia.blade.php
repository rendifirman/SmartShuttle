...
@push('styles')
{{-- Font Awesome (digunakan di frontend) --}}
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

<style>
    /* ==========================================================================
       JADWAL TERSEDIA - DRIVER DASHBOARD
       Minimalist & Clean Design (Diadaptasi dari Frontend)
       ========================================================================== */
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body empty-state">
                    ...
                    <p>Tidak ada jadwal yang tersedia untuk diambil saat ini.</p>
                    <div class="btn-group">
