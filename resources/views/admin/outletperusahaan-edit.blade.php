...
<div class="page-container">
    ...
    <!-- FORM -->
    <form action="{{ route('admin.outletperusahaan.update', $outlet->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="tipe_outlet" id="tipe_outlet" required>
                        ...
                        <option value="regular" {{ old('tipe_outlet', $outlet->tipe_outlet) == 'regular' ? 'selected' : '' }}>Regular</option>
                        <option value="premium" {{ old('tipe_outlet', $outlet->tipe_outlet) == 'premium' ? 'selected' : '' }}>Premium</option>
                        <option value="express" {{ old('tipe_outlet', $outlet->tipe_outlet) == 'express' ? 'selected' : '' }}>Express</option>
                    </select>
                </div>
            </div>
                ...
                <div class="facilities-grid">
                    ...
                    <div class="facility-item">
                        <input type="checkbox" name="fasilitas[]" value="WiFi" id="wifi"
                               {{ in_array('WiFi', $fasilitasArray) ? 'checked' : '' }}>
                        <label for="wifi">WiFi</label>
                    </div>
                    <div class="facility-item">
                        <input type="checkbox" name="fasilitas[]" value="Toilet" id="toilet"
                               {{ in_array('Toilet', $fasilitasArray) ? 'checked' : '' }}>
                        <label for="toilet">Toilet</label>
                    </div>
                    <div class="facility-item">
                        <input type="checkbox" name="fasilitas[]" value="Musholla" id="musholla"
                               {{ in_array('Musholla', $fasilitasArray) ? 'checked' : '' }}>
                        <label for="musholla">Musholla</label>
                    </div>
                    <div class="facility-item">
                        <input type="checkbox" name="fasilitas[]" value="ATM" id="atm"
                               {{ in_array('ATM', $fasilitasArray) ? 'checked' : '' }}>
                        <label for="atm">ATM</label>
                    </div>
                    <div class="facility-item">
                        <input type="checkbox" name="fasilitas[]" value="Charger USB" id="charger"
                               {{ in_array('Charger USB', $fasilitasArray) ? 'checked' : '' }}>
                        <label for="charger">Charger USB</label>
                    </div>
                    <div class="facility-item">
                        <input type="checkbox" name="fasilitas[]" value="AC" id="ac"
                               {{ in_array('AC', $fasilitasArray) ? 'checked' : '' }}>
