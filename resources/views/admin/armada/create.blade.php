...
@section('title', $title ?? 'Tambah Armada')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ $pageTitle ?? 'Tambah Armada' }}</h3>
                ...
                <form action="{{ route('admin.armada.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_shuttle" id="nama_shuttle" class="form-control @error('nama_shuttle') is-invalid @enderror" value="{{ old('nama_shuttle') }}" required>
                                    @error('nama_shuttle')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tipe_shuttle" id="tipe_shuttle" class="form-control @error('tipe_shuttle') is-invalid @enderror" value="{{ old('tipe_shuttle') }}" required>
                                    @error('tipe_shuttle')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="kapasitas_kursi" id="kapasitas_kursi" class="form-control @error('kapasitas_kursi') is-invalid @enderror" value="{{ old('kapasitas_kursi') }}" min="1" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_kursi" id="total_kursi" class="form-control @error('total_kursi') is-invalid @enderror" value="{{ old('total_kursi') }}" min="1" required>
                                    @error('total_kursi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_polisi" id="nomor_polisi" class="form-control @error('nomor_polisi') is-invalid @enderror" value="{{ old('nomor_polisi') }}" required>
                                    @error('nomor_polisi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="fasilitas" id="fasilitas" class="form-control @error('fasilitas') is-invalid @enderror" rows="3">{{ old('fasilitas') }}</textarea>
                            @error('fasilitas')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
