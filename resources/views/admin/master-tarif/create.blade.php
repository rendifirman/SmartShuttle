...
@section('title', 'Tambah Master Tarif')
...
<div class="page-container">
    ...
    <!-- Form Container -->
    <form action="{{ route('admin.master-tarif.store') }}" method="POST" class="form-container">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_tarif" required value="{{ old('nama_tarif') }}" placeholder="Misal: Tarif Reguler">
                </div>
                <div class="form-group">
                    <label>Jenis Tarif <span class="required">*</span></label>
                    <select name="jenis_tarif" required>
                        <option value="">-- Pilih Jenis --</option>
                        <option value="penumpang" {{ old('jenis_tarif') == 'penumpang' ? 'selected' : '' }}>Penumpang</option>
                        <option value="paket" {{ old('jenis_tarif') == 'paket' ? 'selected' : '' }}>Paket</option>
                        <option value="cargo" {{ old('jenis_tarif') == 'cargo' ? 'selected' : '' }}>Cargo</option>
                        <option value="charter" {{ old('jenis_tarif') == 'charter' ? 'selected' : '' }}>Charter</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="sk_tarif" value="{{ old('sk_tarif') }}" placeholder="Misal: No. SK-2026-001">
                    <div class="form-help">Nomor Surat Keputusan atau referensi peraturan tarif</div>
                </div>
                <div class="form-group">
                    <label>Keterangan</label>
                    <input type="text" name="keterangan" value="{{ old('keterangan') }}" placeholder="Deskripsi singkat">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="harga_dasar" required min="0" step="100" value="{{ old('harga_dasar', 0) }}" placeholder="0">
                    <div class="form-help">Harga dasar tarif sebelum diskon</div>
                </div>
                <div class="form-group">
                    <label>Harga Minimum <span class="required">*</span></label>
                    <input type="number" name="harga_minimum" required min="0" step="100" value="{{ old('harga_minimum', 0) }}" placeholder="0">
                    <div class="form-help">Harga terendah yang diizinkan</div>
                </div>
                <div class="form-group">
                    <label>Harga Maksimum</label>
                    <input type="number" name="harga_maksimum" min="0" step="100" value="{{ old('harga_maksimum') }}" placeholder="Kosongkan jika tidak dibatasi">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="diskon_persentase" min="0" max="100" step="0.01" value="{{ old('diskon_persentase', 0) }}" placeholder="0">
                    <div class="form-help">Diskon dalam bentuk persen (0-100%)</div>
                </div>
                <div class="form-group">
                    <label>Diskon Nominal</label>
                    <input type="number" name="diskon_nominal" min="0" step="100" value="{{ old('diskon_nominal', 0) }}" placeholder="0">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                <label>Catatan</label>
                <textarea name="catatan" placeholder="Catatan atau kondisi khusus untuk tarif ini...">{{ old('catatan') }}</textarea>
            </div>
        </div>
